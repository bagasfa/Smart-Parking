      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="/dashboard"><img src="{{secure_asset('assets/img/logo.png')}}" width="25px"> Smart Parking</a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="/dashboard"><img src="{{secure_asset('assets/img/logo.png')}}" width="25px"></a>
          </div>
